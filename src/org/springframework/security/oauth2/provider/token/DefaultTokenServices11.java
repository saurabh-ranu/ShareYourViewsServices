 ...
 * @author Dave Syer
 */
public class DefaultTokenServices11 implements AuthorizationServerTokenServices, ResourceServerTokenServices,
	...
	public OAuth2AccessToken createAccessToken(OAuth2Authentication authentication) throws AuthenticationException {
		...
		System.out.println("existingAccessToken!!! "+existingAccessToken);
		...
		if (refreshToken == null) {
			...
			System.out.println("refreshToken111 "+refreshToken);
		}
